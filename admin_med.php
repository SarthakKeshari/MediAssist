  ...
  <body>
    <nav class="navbar navbar-light bg-light">
      ...
      <div class="container position-sticky top-0">
        <div class="row">
            <div class="col-4">
                <a role="button" class="btn btn-success bg-gradient btn-lg btn-block p-2 mt-5 h1" href="admin_update_med.php">Update Medicine Detail</a>
            </div>
            <div class="col-4">
            <a role="button" class="btn btn-success bg-gradient btn-lg btn-block p-2 mt-5 h1" href="admin_insert_med.php">Insert New Medicine</a>
            </div>
            <div class="col-4">
            <button class="btn btn-success bg-gradient btn-lg btn-block p-2 mt-5 h1" data-toggle="modal" data-target="#exampleModal3" data-whatever="@mdo">Remove Medicine</button>    
            </div>
        </div>
    </div>

    <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <form  action="admin_insert_med.php" method="GET">
                    <div class="modal-dialog">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Remove Medicine</h5>
                            <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="mb-3 d-flex col-4">
                                <label for="recipient-name" class="col-form-label col-8">Medicine ID</label>
    ...
    <?php
            ...
            <thead>
                <tr>
                <th scope="col col-1">Medicine ID</th>
                <th scope="col">Name</th>
                <th scope="col">Cost</th>
                <th scope="col">Capsules/Pack</th>
