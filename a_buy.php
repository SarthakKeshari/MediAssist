  ...
  <div class="container">
    <div class="row pt-4 d-flex align-items-center">
      ...
      <div class="col-7">
        ...
        <div class="row mt-4">
          <form action="pay.php" method="POST" class="col-12">
            <button class="btn btn-success btn-block" type="submit" name="submit" value="<?php echo $_GET['submit']?>">Place Order</button>
          </form>
        </div>
      </div>
    </div>
